...
<!-- Banner -->
<a href="/dsms" class="btn w-full btn-primary text-truncate rounded-0 py-2 border-0 position-relative" style="z-index: 1000;">
    <strong>Welcome to Dashboard</strong> Clic to Visit Main Website →
</a>
        ...
        <div class="container-fluid">
            ...
            <div class="navbar-user d-lg-none">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="sidebarAvatar">
                        ...
                        <a href="/dsms/logout.php" class="dropdown-item">Logout</a>
                    </div>
                </div>
            </div>
            <!-- Collapse -->
            <div class="collapse navbar-collapse" id="sidebarCollapse">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/dsms/logout.php">
                ...
                <div class="mb-npx">
                    <div class="row align-items-center">
                        <div class="col-sm-6 col-12 mb-4 mb-sm-0">
                            <!-- Title -->
                            <h1 class="h2 mb-0 ls-tight">Hi! <?php echo $user_data['user_name']; ?></h1>
                        </div>
                        <!-- Actions -->
